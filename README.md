...
1. Run the following command to fetch the content from Sanity:
        ...
        npx @stackbit/stackbit-pull --stackbit-pull-api-url=https://api.stackbit.com/pull/600f260e7ca19e00159c0e8b
...
To start editing your site, you can use the Sanity interface at https://beige-spider-f260e.sanity.studio/.
...
Generated at `2021-01-25T20:12:58.987Z` by Stackbit version `0.3.44`.